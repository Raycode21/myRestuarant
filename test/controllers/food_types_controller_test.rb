...
class FoodTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_type" do
    assert_difference('FoodType.count') do
      post food_types_url, params: { food_type: { about: @food_type.about, food_group: @food_type.food_group, name: @food_type.name, price: @food_type.price, remote_image_url: @food_type.remote_image_url } }
    end
  ...
  test "should update food_type" do
    patch food_type_url(@food_type), params: { food_type: { about: @food_type.about, food_group: @food_type.food_group, name: @food_type.name, price: @food_type.price, remote_image_url: @food_type.remote_image_url } }
